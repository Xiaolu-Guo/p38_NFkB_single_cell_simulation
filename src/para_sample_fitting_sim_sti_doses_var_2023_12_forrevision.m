...
% clear all
function [] = para_sample_fitting_sim_sti_doses_var_2023_12_forrevision(p38_model,data_save_file_path,input_paras,save_metric_name)
...
for i_proj_num_vec = 1:length(proj_num_vec)
    ...
    switch length(proj_num_vec{i_proj_num_vec})
        ...
        otherwise
            ...
            rand_mat_MKK4 = randn(1,Num_sample(i_proj_num_vec));
            fold_change_log_MKK4 = log(10^0) + rand_mat_MKK4 * sigma_MKK4;
            fold_change_MKK4 = exp(fold_change_log_MKK4)*mean_fold_MKK4;
