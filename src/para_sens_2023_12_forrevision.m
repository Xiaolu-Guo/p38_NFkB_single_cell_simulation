...
% clear all
function [] = para_sens_2023_12_forrevision(p38_model_fold,data_save_file_path,input_paras,save_metric_name)
data_info.save_file_path = data_save_file_path;


fold_change_MKK4 = p38_model_fold.MKK4;
fold_change_MKK6 = p38_model_fold.MKK6;
fold_change_p38 = p38_model_fold.p38;
...
if 1
    data_save_file_path_1 = './';%_fay_parameter/';
...
for i_proj_num_vec = 1:length(proj_num_vec)
    ...
    switch length(proj_num_vec{i_proj_num_vec})
        case 1
            ...
            gene_info.parameter_name_vec = {{'params1'}};
            gene_info.gene_parameter_value_vec_genotype{1}{1} = ones(1,length(fold_change_MKK4));
            gene_info.species_name_vec= {{'MKK4_off','MKK6_off','p38_off'}};
            
            
            gene_info.species_value_vec_genotype{1}{1} = [0.1*fold_change_MKK4;
