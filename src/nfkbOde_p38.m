...
rxn_4 = p(4,1) * IKK_i;
rxn_5 = p(5,1);
rxn_6 = p(6,1) * (NFkBn_cas2.^p(6,2))/( (NFkBn_cas2.^p(6,2)) + (p(6,3).^p(6,2)) );
rxn_7 = p(7,1) * IkBat;
rxn_8 = p(8,1) * IkBat_cas2;
rxn_9 = p(9,1) * IkBa; % *p(9,2) 
rxn_10 = p(10,1) * NFkB;
rxn_11 = p(11,1) * IkBan;
rxn_12 = p(12,1) * NFkBn;
...
rxn_51 = p(51,1) * TRAF6;
rxn_52 = p(52,1) * p(52,2) * TRAF6 * TAK1_off;
rxn_53 = p(53,1) * TNF;
rxn_54 = p(54,1);
rxn_55 = p(55,1) * TNFR;
...
rxn_63 = p(63,1) * C1;
rxn_64 = p(64,1) * C1;
rxn_65 = p(65,1) * p(65,2) * C1 * TAK1_off;
rxn_66 = p(66,1) * TAK1;
...
rxn_95 = p(95,1) * NFkB;
rxn_96 = p(96,1) * IkBat;
rxn_97 = p(97,1) * IkBat_cas1;
rxn_98 = p(98,1) * IkBat_cas2;
rxn_99 = p(99,1) * NFkBn;
rxn_100 = p(100,1) * NFkBn_cas1;
rxn_101 = p(101,1) * NFkBn_cas2;

rxn_102 = p(102,1) * (IKK.^p(102,2))./(IKK.^p(102,2) + p(102,3).^p(102,2)) * MKK6_off; % 
rxn_103 = p(103,1) * pMKK6;
rxn_104 = p(104,1) * (IKK.^p(104,2))./(IKK.^p(104,2) + p(104,3).^p(104,2)) * pMKK6;
rxn_105 = p(105,1) * ppMKK6;

rxn_106 = p(106,1) * (TAK1.^p(106,2))./(TAK1.^p(106,2) + p(106,3).^p(106,2))  * MKK4_off; % 
rxn_107 = p(107,1) * pMKK4;
rxn_108 = p(108,1) * (TAK1.^p(108,2))./(TAK1.^p(108,2) + p(108,3).^p(108,2))  * pMKK4; % 
rxn_109 = p(109,1) * ppMKK4;

rxn_110 = p(110,1) * (ppMKK6.^p(110,2))./(ppMKK6.^p(110,2) + p(110,3).^p(110,2))  * p38_off; % 
rxn_111 = p(111,1) * (ppMKK4.^p(111,2))./(ppMKK4.^p(111,2) + p(111,3).^p(111,2))  * p38_off; % 
rxn_112 = p(112,1) * pp38;
rxn_113 = p(113,1) * (ppMKK6.^p(113,2))./(ppMKK6.^p(113,2) + p(113,3).^p(113,2))  * pp38; % 
rxn_114 = p(114,1) * (ppMKK4.^p(114,2))./(ppMKK4.^p(114,2) + p(114,3).^p(114,2))  * pp38; % 
rxn_115 = p(115,1) * ppp38;
...
delta(6) = rxn_5 + rxn_6 - rxn_96; %- rxn_7 + 
...
delta(49) = rxn_96 - rxn_97; %
delta(50) = rxn_97 - rxn_98;
delta(51) = rxn_99 - rxn_100;
delta(52) = rxn_100 - rxn_101;
delta(53) = - rxn_102 + rxn_103;
delta(54) = rxn_102 - rxn_103 - rxn_104 + rxn_105;
delta(55) = rxn_104 - rxn_105;
delta(56) = -rxn_106 + rxn_107;
delta(57) = rxn_106 - rxn_107 - rxn_108 + rxn_109;
delta(58) = rxn_108 - rxn_109;
delta(59) = - rxn_111 - rxn_110 + rxn_112;
delta(60) = rxn_111 + rxn_110 - rxn_112 - rxn_113 - rxn_114 + rxn_115;
delta(61) = rxn_113 + rxn_114 - rxn_115;