function [] = draw_p38_NFkB_denoise_3model_sim_features_Figure6F_0311(fig_save_path)
...
if 1
    ...
    if 1
        ...
        if 1 % 4 different denoise
            ...
            % h.Title = strcat('');
            caxis([-1,1])
            saveas(gcf,strcat(fig_save_path,'Figure6F_spearman_corr_feature_allrep' ),'epsc')
            saveas(gcf,strcat(fig_save_path,'Figure6F_spearman_corr_feature_allrep',num2str(rep) ),'svg')
