function [params, species] = nfkbInitialize_p38()
...
params(102,1) = 0.516497639;%0.03;0.05 4e-5; % single phosphorilation of MKK6 Vmax
params(102,2) = 1; % single phosphorilation of MKK6 Hill coefficient n
params(102,3) = 0.031237844; % single phosphorilation of MKK6 Kd
params(103,1) = 0.301366072; %0.14 dephosporilation of single pMKK6

params(104,1) = params(102,1); % double phosphorilation of MKK6 Vmax
params(104,2) = params(102,2); % double phosphorilation of MKK6 Hill coefficient n
params(104,3) = params(102,3); % double phosphorilation of MKK6 Kd
params(105,1) = params(103,1); % dephosporilation of double ppMKK6

params(106,1) = 0.012683641; %0.005 % 2.7e-4; % single phosphorilation of MKK4 Vmax
params(106,2) = 1; % single phosphorilation of MKK4 Hill coefficient n
params(106,3) = 0.000114767; %0.0001 single phosphorilation of MKK4 Kd
params(107,1) = 0.012320076; % 0.8 dephosporilation of single pMKK4

params(108,1) = params(106,1); % double phosphorilation of MKK4 Vmax
params(108,2) = params(106,2); % double phosphorilation of MKK4 Hill coefficient n
params(108,3) = params(106,3); % double phosphorilation of MKK4 Kd
params(109,1) = params(107,1); % dephosporilation of double pMKK4

params(110,1) = 5.241056524;%1.6e5; % single phosphorilation of p38 through MKK6 Vmax
params(110,2) = 1; % single phosphorilation of p38 through MKK6 Hill coefficient n
params(110,3) = 0.299043472; % single phosphorilation of p38 through MKK6 Kd
params(111,1) = 1.03505377;% 345.7; % single phosphorilation of p38 through MKK4 Vmax
params(111,2) = 1; % single phosphorilation of p38 through MKK4 Hill coefficient n
params(111,3) = 0.103901535; % single phosphorilation of p38 through MKK4 Kd
params(112,1) = 0.624002416; % dephosporilation of single pp38

params(113,1) = params(110,1); % single phosphorilation of p38 through MKK6 Vmax
params(113,2) = params(110,2); % single phosphorilation of p38 through MKK6 Hill coefficient n
params(113,3) = params(110,3); % single phosphorilation of p38 through MKK6 Kd
params(114,1) = params(111,1); % single phosphorilation of p38 through MKK4 Vmax
params(114,2) = params(111,2); % single phosphorilation of p38 through MKK4 Hill coefficient n
params(114,3) = params(111,3); % single phosphorilation of p38 through MKK4 Kd
params(115,1) = params(112,1); % dephosporilation of single pp38
